...
#define CELL_COUNT_X  9
#define CELL_COUNT_Y  9
#define CELL_COUNT_Z  9
  ...
  for(int zt=-1; zt<2; zt++){ // Traverse subgrid
    for(int yt=-1; yt<2; yt++){
      for(int xt=-1; xt<2; xt++){
        ...
        cell_array[nb_index] = LATENCY; 
      } 
    } 
  } // Traverse subgrid 
  cout << "step 0" << endl;
  //print_matrix(cell_array, CELL_COUNT_X, CELL_COUNT_Y, CELL_COUNT_Z);
