...
file0 = fopen('../../rtl/clustered_greens_rom.svh', 'w');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
file0 = fopen('../../tb/include/particle_info.svh', 'w');
...
%  p_oi_x(ll+1) = sfi(rand, 32, 10);
%  p_oi_y(ll+1) = sfi(rand, 32, 10);
%  p_oi_z(ll+1) = sfi(rand, 32, 10);

%  p_q(ll+1) = sfi(2*rand, 32, 10);
...
file0 = fopen('../../tb/include/gmem_fftx_check_values.svh', 'w');
...
% Create Verilog header file
file0 = fopen('../../tb/include/gmem_ffty_check_values.svh', 'w');
...
% Create Verilog header file
file0 = fopen('../../tb/include/gmem_fftz_check_values.svh', 'w');
...
% Create Verilog header file
file0 = fopen('../../tb/include/gmem_ifftx_check_values.svh', 'w');
...
% Create Verilog header file
file0 = fopen('../../tb/include/gmem_iffty_check_values.svh', 'w');
...
% Create Verilog header file
file0 = fopen('../../tb/include/gmem_ifftz_check_values.svh', 'w');
...
file0 = fopen('../../tb/include/force_info.svh', 'w');
